odoo.define("pos_show_dual_currency.MultiCurrencyScreen", function(require) {
    "use strict";
    ...
    //screens.OrderWidget.include({
        _updateSummary(){
            ...
            if(this.pos.config.show_dual_currency){
                ...
                this.el.querySelector('.summary .line .entry_total .total_show .value').textContent = this.format_currency(total);
                this.el.querySelector('.summary .line .entry_total .total_show .value_currency').textContent = total_currency_text;
                this.el.querySelector('.summary .line .entry_total .subentry .value').textContent = this.format_currency(taxes);
                this.el.querySelector('.summary .line .entry_total .subentry .value_currency').textContent = taxes_currency_text;
            }else{
                this.el.querySelector('.summary .line .entry_total .value').textContent = this.format_currency(total);
                this.el.querySelector('.summary .line .entry_total .subentry .value').textContent = this.format_currency(taxes);
            }
        }
    };
    ...
    Registries.Component.add(MultiCurrencyScreen);
