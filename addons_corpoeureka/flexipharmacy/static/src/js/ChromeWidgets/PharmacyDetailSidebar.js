odoo.define('flexipharmacy.PharmacyDetailSidebar', function(require) {
    ...
    class PharmacyDetailSidebar extends PosComponent { 
        constructor() {
            ...
            useListener('reporte-x', async () => {

                if (confirm("Confirmación para reporte X")) {

                    return fetch("http://127.0.0.1/FIscalPrinter/reporte_x.php?"+"port="+ this.env.pos.config.fiscal_port, {
                        method: "GET",
                        headers: {
            ...
            useListener('reporte-z', async () => {

                if (confirm("Confirmación para reporte Z")) {

                    return fetch("http://127.0.0.1/FIscalPrinter/reporte_z.php?"+"port="+ this.env.pos.config.fiscal_port, {
                        method: "GET",
                        headers: {
                            "Content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                        },
