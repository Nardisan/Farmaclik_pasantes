odoo.define('theme_clarico_vega.dropdown_animate', function (require) {
    ...
    publicWidget.registry.dropdown_animate= publicWidget.Widget.extend({
        ...
        showDropdown: function() {
            ...
            $('.te_advanced_search_div .dropdown, .dropdown, .te_header_before_overlay .js_language_selector .dropup, header .js_language_selector .dropup').on('show.bs.dropdown', function() {
                $(this).find('.dropdown-menu').first().stop(true, true).slideDown(150);
            });
            $('.te_advanced_search_div .dropdown, .dropdown, .te_header_before_overlay .js_language_selector .dropup, header .js_language_selector .dropup').on('hide.bs.dropdown', function() {
