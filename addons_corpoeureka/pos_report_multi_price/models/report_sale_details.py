...
class ReportSaleDetails(models.AbstractModel):
    ...
    def get_sale_details(self, date_start=False, date_stop=False, config_ids=False, session_ids=False):
        res = super(ReportSaleDetails, self).get_sale_details(date_start=date_start,date_stop=date_stop)
        ...
        # config = self.env['pos.config'].browse(config_ids)
    ...
    def _get_report_values(self, docids, data=None):
        res = super(ReportSaleDetails, self)._get_report_values(docids,data)
        data = dict(data or {})
